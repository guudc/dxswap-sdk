...
import { mainnet, rinkeby, ropsten, arbitrumTestnetV3, sokol, xdai, matic } from 'dxswap-core/.contracts.json';
import { rinkeby as rinkeby$1, ropsten as ropsten$1, mainnet as mainnet$1, arbitrumTestnetV3 as arbitrumTestnetV3$1, sokol as sokol$1, xdai as xdai$1, matic as matic$1 } from 'dxswap-periphery/.contracts.json';
...
var FACTORY_ADDRESS = (_FACTORY_ADDRESS = {}, _FACTORY_ADDRESS[ChainId.MAINNET] = mainnet.factory, _FACTORY_ADDRESS[ChainId.RINKEBY] = rinkeby.factory,  _FACTORY_ADDRESS[ChainId.ROPSTEN] = ropsten.factory, _FACTORY_ADDRESS[ChainId.ARBITRUM_TESTNET_V3] = arbitrumTestnetV3.factory, _FACTORY_ADDRESS[ChainId.SOKOL] = sokol.factory, _FACTORY_ADDRESS[ChainId.XDAI] = xdai.factory, _FACTORY_ADDRESS[ChainId.MATIC] = matic.factory, _FACTORY_ADDRESS);
var ROUTER_ADDRESS = (_ROUTER_ADDRESS = {}, _ROUTER_ADDRESS[ChainId.RINKEBY] = rinkeby$1.router, _ROUTER_ADDRESS[ChainId.ROPSTEN] = ropsten$1.router, _ROUTER_ADDRESS[ChainId.MAINNET] = mainnet$1.router, _ROUTER_ADDRESS[ChainId.ARBITRUM_TESTNET_V3] = arbitrumTestnetV3$1.router, _ROUTER_ADDRESS[ChainId.SOKOL] = sokol$1.router, _ROUTER_ADDRESS[ChainId.XDAI] = xdai$1.router, _ROUTER_ADDRESS[ChainId.MATIC] = matic$1.router, _ROUTER_ADDRESS);
var STAKING_REWARDS_FACTORY_ADDRESS = (_STAKING_REWARDS_FACT = {}, _STAKING_REWARDS_FACT[ChainId.MAINNET] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT[ChainId.RINKEBY] = '0xDcA39454f0B83c6f0807708b0E6a620dd9BA6808', _STAKING_REWARDS_FACT[ChainId.ARBITRUM_TESTNET_V3] = '0xB95Ad562EDE8DD78BBFC287fA18150e802b09D9F', _STAKING_REWARDS_FACT[ChainId.SOKOL] = '0xD436e756Cf41318ADeC62E8dCbEF2608753Ae068', _STAKING_REWARDS_FACT[ChainId.XDAI] = '0xCD2A45F36464FdB1065160e03A2353996Ea8Ff57', _STAKING_REWARDS_FACT[ChainId.MATIC] = '0x0000000000000000000000000000000000001234', _STAKING_REWARDS_FACT);
...
var DXSWAP_TOKEN_LIST_ID = (_DXSWAP_TOKEN_LIST_ID = {}, _DXSWAP_TOKEN_LIST_ID[ChainId.MAINNET] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.RINKEBY] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.ARBITRUM_TESTNET_V3] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.SOKOL] = 1, _DXSWAP_TOKEN_LIST_ID[ChainId.XDAI] = 5, _DXSWAP_TOKEN_LIST_ID[ChainId.MATIC] = 137, _DXSWAP_TOKEN_LIST_ID);
var INIT_CODE_HASH = (_INIT_CODE_HASH = {}, _INIT_CODE_HASH[ChainId.MAINNET] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.RINKEBY] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.ROPSTEN] = '0x529e32449a708ef61aee26c9a6e8a631b51250b7f5359812c0675298d78156b3', _INIT_CODE_HASH[ChainId.ARBITRUM_TESTNET_V3] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.SOKOL] = '0xd306a548755b9295ee49cc729e13ca4a45e00199bbd890fa146da43a50571776', _INIT_CODE_HASH[ChainId.XDAI] = '0x3f88503e8580ab941773b59034fb4b2a63e86dbc031b3633a925533ad3ed2b93', _INIT_CODE_HASH[ChainId.MATIC] = '0xae81bbc68f315fbbf7617eb881349af83b1e95241f616966e1e0583ecd0793fe', _INIT_CODE_HASH);
...
Token.NATIVE_CURRENCY_WRAPPER = (_Token$NATIVE_CURRENC = {}, _Token$NATIVE_CURRENC[ChainId.MAINNET] = Token.WETH[ChainId.MAINNET], _Token$NATIVE_CURRENC[ChainId.RINKEBY] = Token.WETH[ChainId.RINKEBY], _Token$NATIVE_CURRENC[ChainId.ARBITRUM_TESTNET_V3] = Token.WETH[ChainId.ARBITRUM_TESTNET_V3], _Token$NATIVE_CURRENC[ChainId.SOKOL] = Token.WSPOA[ChainId.SOKOL], _Token$NATIVE_CURRENC[ChainId.XDAI] = Token.WXDAI[ChainId.XDAI], _Token$NATIVE_CURRENC[ChainId.MATIC] = Token.WMATIC[ChainId.MATIC], _Token$NATIVE_CURRENC);
/**
...
var INITIAL_CACHE_STATE = (_INITIAL_CACHE_STATE = {}, _INITIAL_CACHE_STATE[ChainId.MAINNET] = {}, _INITIAL_CACHE_STATE[ChainId.RINKEBY] = {}, _INITIAL_CACHE_STATE[ChainId.ARBITRUM_TESTNET_V3] = {}, _INITIAL_CACHE_STATE[ChainId.SOKOL] = {}, _INITIAL_CACHE_STATE[ChainId.XDAI] = {}, _INITIAL_CACHE_STATE[ChainId.MATIC] = {}, _INITIAL_CACHE_STATE);
...
var TOKEN_LOGO_URI_CACHE = (_TOKEN_LOGO_URI_CACHE = {}, _TOKEN_LOGO_URI_CACHE[ChainId.MAINNET] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.XDAI] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.SOKOL] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.ARBITRUM_TESTNET_V3] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.RINKEBY] = {}, _TOKEN_LOGO_URI_CACHE[ChainId.MATIC] = {}, _TOKEN_LOGO_URI_CACHE);
/**
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchDxDaoTokenList = function fetchDxDaoTokenList(chainId) {
    try {
      ...
      var tokenListUrl = new Map([[1, 'https://tokens.coingecko.com/uniswap/all.json'], [100, 'https://unpkg.com/@1hive/default-token-list@latest/build/honeyswap-default.tokenlist.json'], [137, 'https://unpkg.com/@1hive/default-token-list@latest/build/honeyswap-default.tokenlist.json'] //       [100, 'https://tokens.honeyswap.org'],
